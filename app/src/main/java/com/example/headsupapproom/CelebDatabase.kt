...
@Database(entities= [CelebTable::class], version = 1, exportSchema = false)
abstract class CelebDatabase : RoomDatabase() {
    ...
    companion object{
        var instance:CelebDatabase?=null
        ...
        fun getInstance(context: Context):CelebDatabase {
            ...
            instance= Room.databaseBuilder(context,CelebDatabase::class.java, "data").run {allowMainThreadQueries()}.build();
    ...
    abstract fun getCelebDao():CelebDao
